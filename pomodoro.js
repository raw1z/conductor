...
var author$project$Pomodoro$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var author$project$Pomodoro$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(elm$time$Time$every, 1000, author$project$Pomodoro$Tick),
...
var author$project$Pomodoro$processKey = F2(
	function (model, key) {
		...
		var maybeSelectedTask = elm$core$List$head(
			A2(elm$core$List$filter, isSelected, model.tasks));
		switch (key) {
			case 'n':
				return _Utils_Tuple2(
					model,
...
var author$project$Pomodoro$Pause = function (a) {
	return {$: 'Pause', a: a};
};
...
var author$project$Pomodoro$shiftTimer = function (timer) {
	var _n0 = timer.status;
	switch (_n0.$) {
		case 'Work':
			if (_n0.a === 4) {
				var newTimer = _Utils_update(
					timer,
					{initialValue: author$project$Pomodoro$longPauseTimeout, status: author$project$Pomodoro$LongPause, timeout: author$project$Pomodoro$longPauseTimeout});
				return _Utils_Tuple2(
					elm$core$Maybe$Just(newTimer),
					author$project$Pomodoro$notify('Take some rest...'));
			} else {
				var count = _n0.a;
				var newTimer = _Utils_update(
					timer,
				...
				return _Utils_Tuple2(
					elm$core$Maybe$Just(newTimer),
					author$project$Pomodoro$notify('Take a breathe...'));
			}
		case 'Pause':
			var newTimer = _Utils_update(
				timer,
				{status: author$project$Pomodoro$Inactive});
			return _Utils_Tuple2(
				elm$core$Maybe$Just(newTimer),
				author$project$Pomodoro$notify('Ready'));
		case 'LongPause':
			var newTimer = _Utils_update(
				timer,
				{status: author$project$Pomodoro$Inactive});
		...
		default:
			return _Utils_Tuple2(
				elm$core$Maybe$Just(timer),
				elm$core$Platform$Cmd$none);
	}
};
var author$project$Pomodoro$decreaseTimer = function (timer) {
	...
	if (!_n0) {
		...
		var newTimer = _Utils_update(
			timer,
			{timeout: timer.timeout - 1});
		return _Utils_Tuple2(
			elm$core$Maybe$Just(newTimer),
			elm$core$Platform$Cmd$none);
	}
};
var author$project$Pomodoro$updateTimerAtTick = function (model) {
	var _n0 = model.timer;
	if (_n0.$ === 'Nothing') {
		return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	} else {
...
var author$project$Pomodoro$formatMinutesOrSeconds = function (value) {
	return A3(
...
var author$project$Pomodoro$viewTimerTimeout = function (timer) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				author$project$Pomodoro$formatMinutesOrSeconds(minutes)),
				elm$html$Html$text(':'),
				elm$html$Html$text(
				author$project$Pomodoro$formatMinutesOrSeconds(seconds))
			]));
};
...
var author$project$ProgressRing$viewProgress = F3(
	function (radius, thickness, progress) {
		var realRadius = radius - (2 * thickness);
		var circumference = (radius * 2) * elm$core$Basics$pi;
		var dashArray = elm$core$String$fromInt(
			elm$core$Basics$round(circumference)) + (' ' + elm$core$String$fromInt(
			elm$core$Basics$round(circumference)));
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$core$String$fromInt(realRadius)),
					...
					_List_fromArray(
						[
							elm$svg$Svg$Attributes$class('progress-ring__circle'),
							elm$svg$Svg$Attributes$fill('transparent'),
							elm$svg$Svg$Attributes$stroke('white'),
							elm$svg$Svg$Attributes$strokeWidth(
							elm$core$String$fromInt(thickness)),
							elm$svg$Svg$Attributes$strokeLinecap('round'),
							elm$svg$Svg$Attributes$strokeDasharray(dashArray),
							elm$svg$Svg$Attributes$strokeDashoffset(
							elm$core$String$fromInt(dashOffset)),
							elm$svg$Svg$Attributes$r(
							elm$core$String$fromInt(realRadius)),
							elm$svg$Svg$Attributes$cx(
							elm$core$String$fromInt(radius)),
...
var author$project$Pomodoro$viewTimerProgress = function (timer) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('timer-progress')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('timer-progress-ring')
					]),
				_List_fromArray(
					[
						A3(author$project$ProgressRing$viewProgress, 150, 6, progress)
					])),
